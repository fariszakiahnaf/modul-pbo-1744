...
public class LibrarySystemApp extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Main Menu
        ImageView imageView = new ImageView(new Image("https://png.pngtree.com/png-clipart/20210702/ourmid/pngtree-simple-hello-text-handwriting-png-image_3548451.jpg"));
    ...
    private void showStudentMenu(Stage stage, Student student) {
        ...
        HBox studentMenu = new HBox(10, label, displayBooksButton, choiceBookButton, returnBookButton, backButton);
